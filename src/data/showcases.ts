...
export const showcaseData: Record<string, Record<Language, ShowcaseProduct>> = {
  ...
  chat: {
    zh: {
      ...
      heroSubheadline: '端到端军事级加密传输，全平台无缝同步。无广告、无干扰、不采集任何私人数据，让对话回归纯粹的安全与自由。',
      accentColor: '#0ea5e9',
    ...
    en: {
      id: 'chat',
      tag: 'BETA · PRIVACY FIRST',
      tagColor: 'from-sky-500 to-blue-600',
      title: 'Instant Messaging · GongPan Chat',
      heroHeadline: 'Your Own Telegram. Pure. Private. Fast.',
      heroSubheadline: 'Military-grade end-to-end encryption with seamless multi-platform sync. No ads, zero tracking, and uncompromising performance.',
      accentColor: '#0ea5e9',
      gradient: 'from-sky-500/20 via-blue-600/10 to-transparent',
      heroImage: 'https://wsrv.nl/?url=images.unsplash.com/photo-1611746872915-64382b5c76da&w=1200&q=75&output=webp',
      targetUrl: 'http://gongcheng.yyboxdns.com:21312/',
    ...
    ja: {
      ...
      heroSubheadline: '軍用レベルのエンドツーエンド暗号化とシームレスなマルチデバイス同期。広告なし、追跡なし。',
      accentColor: '#0ea5e9',
      gradient: 'from-sky-500/20 via-blue-600/10 to-transparent',
      heroImage: 'https://wsrv.nl/?url=images.unsplash.com/photo-1611746872915-64382b5c76da&w=1200&q=75&output=webp',
      targetUrl: 'http://gongcheng.yyboxdns.com:21312/',
    ...
    ko: {
      ...
      heroSubheadline: '군사 등급 종단간 암호화와 멀티 플랫폼 동기화. 광고 없음, 추적 없음.',
      accentColor: '#0ea5e9',
      gradient: 'from-sky-500/20 via-blue-600/10 to-transparent',
      heroImage: 'https://wsrv.nl/?url=images.unsplash.com/photo-1611746872915-64382b5c76da&w=1200&q=75&output=webp',
      targetUrl: 'http://gongcheng.yyboxdns.com:21312/',
    ...
    es: {
      id: 'chat',
      tag: 'BETA · MÁXIMA PRIVACIDAD',
      tagColor: 'from-sky-500 to-blue-600',
      title: 'Mensajería · GongPan Chat',
      heroHeadline: 'Puro. Privado. Ultrarrápido.',
      heroSubheadline: 'Cifrado de extremo a extremo y sincronización multiplataforma. Cero anuncios y máxima seguridad.',
      accentColor: '#0ea5e9',
      gradient: 'from-sky-500/20 via-blue-600/10 to-transparent',
      heroImage: 'https://wsrv.nl/?url=images.unsplash.com/photo-1611746872915-64382b5c76da&w=1200&q=75&output=webp',
      targetUrl: 'http://gongcheng.yyboxdns.com:21312/',
    ...
    fr: {
      id: 'chat',
      tag: 'BETA · CONFIDENTIALITÉ TOTALE',
      tagColor: 'from-sky-500 to-blue-600',
      title: 'Messagerie Instantanée · GongPan Chat',
      heroHeadline: 'Pur. Privé. Instantané.',
      heroSubheadline: 'Chiffrement de bout en bout de niveau militaire et synchronisation multiplateforme sans compromis.',
      accentColor: '#0ea5e9',
      gradient: 'from-sky-500/20 via-blue-600/10 to-transparent',
      heroImage: 'https://wsrv.nl/?url=images.unsplash.com/photo-1611746872915-64382b5c76da&w=1200&q=75&output=webp',
      targetUrl: 'http://gongcheng.yyboxdns.com:21312/',
    ...
    de: {
      id: 'chat',
      tag: 'BETA · MAXIMALE PRIVATSPHÄRE',
      tagColor: 'from-sky-500 to-blue-600',
      title: 'Instant Messaging · GongPan Chat',
      heroHeadline: 'Rein. Privat. Rasend schnell.',
      heroSubheadline: 'Militärische Ende-zu-Ende-Verschlüsselung und nahtlose Synchronisation. Keine Werbung, kein Tracking.',
      accentColor: '#0ea5e9',
      gradient: 'from-sky-500/20 via-blue-600/10 to-transparent',
      heroImage: 'https://wsrv.nl/?url=images.unsplash.com/photo-1611746872915-64382b5c76da&w=1200&q=75&output=webp',
      targetUrl: 'http://gongcheng.yyboxdns.com:21312/',
    ...
    el: {
      id: 'chat',
      tag: 'BETA · ΑΠΟΛΥΤΗ ΙΔΙΩΤΙΚΟΤΗΤΑ',
      tagColor: 'from-sky-500 to-blue-600',
      title: 'Άμεσα Μηνύματα · GongPan Chat',
      heroHeadline: 'Καθαρό. Ιδιωτικό. Αστραπιαίο.',
      heroSubheadline: 'Κρυπτογράφηση από άκρο σε άκρο στρατιωτικού επιπέδου και συγχρονισμός σε όλες τις συσκευές.',
      accentColor: '#0ea5e9',
      gradient: 'from-sky-500/20 via-blue-600/10 to-transparent',
      heroImage: 'https://wsrv.nl/?url=images.unsplash.com/photo-1611746872915-64382b5c76da&w=1200&q=75&output=webp',
      targetUrl: 'http://gongcheng.yyboxdns.com:21312/',
